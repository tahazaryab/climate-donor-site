import styles from "../styles/SmallProjectCard.module.css";
...
const ProjectCard = ({ project, isOwner }) => {
  return (
    <Link
      href={isOwner ? `/owner/project/${project.id}` : `/project/${project.id}`}
    >
      <div className={styles.projectCard}>
        ...
        <div className={styles.cardContent}>
          ...
          <div className={styles.labels}>
            <span>
              <FontAwesomeIcon icon={faUser} /> {project.author}
            </span>
            <span>
