...
const ProjectownerSignUpInfoPage = ({
	formData,
	setForm,
	errorMessage,
	setErrorMessage,
		...
		<Row type="flex" align="middle" justify="space-around">
			<Col span={8}>
				<div className="container">
					...
					<p>
						Whether you want to make a donation or post a project, creating an
						account allows you to keep track fo your contributions and progress.
					</p>
